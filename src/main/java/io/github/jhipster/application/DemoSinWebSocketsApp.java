...
public class DemoSinWebSocketsApp {

    private static final Logger log = LoggerFactory.getLogger(DemoSinWebSocketsApp.class);

    private final Environment env;

    public DemoSinWebSocketsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes DemoSinWebSockets.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DemoSinWebSocketsApp.class);
